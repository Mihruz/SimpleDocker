...
- Просканировать образ из предыдущего задания через `dockle [image_id|repository]`
  ![](img/5_2.jpg)
- Вносим исправления в Dockerfile для устранения ошибок (добавляем команду upgrade, очищаем кэш после установки пакетов, добавляем нового пользователя и прописываем ему права на доступ к папкам).
 Для исправления ошибки CIS-DI-0010 меняем образ c nginx на ubuntu и отдельно устанавливаем пакет nginx (также вносим изменения в скрипт run.sh для запуска сервиса nginx)
  ![](img/5_3.jpg)
  ![](img/5_4.jpg)
- Повторно собираем и проверяем образ, dockle показывает только информационные сообщения
  ![](img/5_5.jpg)
